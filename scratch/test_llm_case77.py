"""
Test Case 77 through LLM extractor (commercial invoice).
Usage: python scratch/test_llm_case77.py
"""
...
from tests.test_cases_commercial import rawtext_77, zoomtext_77

raw = rawtext_77()
zoom = zoomtext_77()

print(f"{'='*80}")
print(f"[77] STAVIAN CHEMICAL — Calling LLM...")
print(f"{'='*80}")
